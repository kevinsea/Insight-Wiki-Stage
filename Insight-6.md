...
* JW - RP, I had another guy comment over email that he'd prefer that I keep it simple. In fact, he didn't like some of the object mapping features I added in the last version. I think that's the real feedback I'm asking about. I **could** do all of this, but my intuition says that it's a time sink, and probably isn't the most useful -- i.e. if I make it close to EF or something big, why not just use one of those? So, right now, my thoughts are to *not* do any of this. I think if I do anything, I'd rather get the schema & autoproc stuff working on another (good) database engine.